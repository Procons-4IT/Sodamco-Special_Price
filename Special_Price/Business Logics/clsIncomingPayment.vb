                ...
                If (eventInfo.BeforeAction = True) Then
                    ...
                    Try
                        ...
                        If oApplication.Utilities.getEditTextvalue(oForm, "5") <> "" Or ocheck.Selected = True Then
                            ...
                            If Not oMenuItem.SubMenus.Exists(mnu_COMM_I) Then
                                ...
                                oCreationPackage.UniqueID = "ComChargesI"
                            ...
                            End If
                        Else
                            If oApplication.SBO_Application.Menus.Exists(mnu_COMM_I) Then
                                oApplication.SBO_Application.Menus.RemoveEx(mnu_COMM_I)
                            End If
                        End If
                    Catch ex As Exception
                        oApplication.Utilities.Message(ex.Message, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
...
#Region "Function"
    Private Sub initializeControls(ByVal oForm As SAPbouiCOM.Form)
        Try
            oApplication.Utilities.AddControls(oForm, "_53", "53", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", 0, 0, "", "Commission Ref", 0, 0, 0, False)
            oApplication.Utilities.AddControls(oForm, "_52", "52", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", 0, 0, "", "", 0, 0, 0, True)
    ...
    Private Sub dataBind(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            oEditText.DataBind.SetBound(True, "ORCT", "U_RefCode")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
